...
const namePrefix = "Odysseus Club";
const description = "Own your own piece of the Odysseus universe and also gain access to a range of exclusive owner benefits.";
...
const CONTRACT_NAME = 'Odysseus Club';
const CONTRACT_SYMBOL = 'ODS';
...
const GENERIC_DESCRIPTION = "Which piece of the Odysseus universe will you get?"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafybeicyewfntnbfguecdthhwa23t3ayea7r4jej6wrlfs5jfto75se6w4"; // Replace with your generic image that will display for all NFTs pre-reveal.
